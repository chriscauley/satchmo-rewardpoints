...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Reward'
        db.create_table('reward_reward', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contact', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reward', unique=True, to=orm['contact.Contact'])),
            ('points', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('reward', ['Reward'])

        # Adding model 'RewardItem'
        db.create_table('reward_rewarditem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('reward', self.gf('django.db.models.fields.related.ForeignKey')(related_name='reward_items', to=orm['reward.Reward'])),
            ('points', self.gf('django.db.models.fields.IntegerField')()),
            ('points_value', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('transaction_description', self.gf('django.db.models.fields.CharField')(max_length=120, null=True, blank=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Order'], unique=True, null=True, blank=True)),
            ('orderpayment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.OrderPayment'], null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.IntegerField')()),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('reward', ['RewardItem'])


    def backwards(self, orm):
        # Deleting model 'Reward'
        db.delete_table('reward_reward')

        # Deleting model 'RewardItem'
        db.delete_table('reward_rewarditem')
    ...
    models = {
        ...
        'reward.rewarditem': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.Order']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'orderpayment': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.OrderPayment']", 'null': 'True', 'blank': 'True'}),
